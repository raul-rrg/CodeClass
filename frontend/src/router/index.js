...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/tournaments/create', name: 'tournament-create', component: () => import('@/views/CreateTournament.vue'), meta: { requiresAuth: true, requiresTeacher: true } },
    { path: '/tournaments/:id', name: 'tournament', component: () => import('@/views/Tournament.vue') },
    { path: '/about', name: 'about', component: () => import('@/views/About.vue'), meta: { requiresGuest: true } },
    ...
    { path: '/progreso', name: 'progress', component: () => import('@/views/Progress.vue'), meta: { requiresAuth: true } },
